...
st.write("Top 5 Customers by Total Booking Value")
...
if powerbi_url != "https://app.powerbi.com/view?r=eyJrIjoiOTg2M2MxYTMtYWM4ZC00MDMzLWJiZTgtMzE5MDRlMWJhMTgyIiwidCI6ImJiYzIxNzVlLTUyZDEtNGVkNi1iYzNhLTNhYzQ3OWY1ODM5ZCIsImMiOjEwfQ%3D%3D":
    st.components.v1.iframe(powerbi_url, height=600)
else:
    st.info("Add your Power BI embed URL to display dashboard.")